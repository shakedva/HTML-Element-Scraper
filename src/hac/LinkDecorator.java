...
/**
 * Class that inherit from the Decorator class, decorator for the link elements.
 */
public class LinkDecorator extends Decorator{
    /**
     * Constructor for the link elements decorator.
     ...
     */
    public LinkDecorator(Scraper scraper, Document doc)
    {
        super(scraper,doc);
    }
    ...
    public void write(FileWriter fileWriter) throws IOException {
        ...
        // get all the elements for <a> tag and iterate through them and write the data to an output file.
        Elements elements = this.doc.getElementsByTag("a");
        for (Element element : elements)
        {
            fileWriter.write(element.attr("abs:href"));
